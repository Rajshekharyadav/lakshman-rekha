...
import { ShieldCheck, CloudRain, Sprout, AlertCircle, Phone } from "lucide-react";
import { useState } from "react";
import { useLocation } from "wouter";
import { useToast } from "@/hooks/use-toast";

export default function Login() {
  const { signInWithGoogle, signInWithCredentials, signUp, user } = useAuth();
      ...
      <div className="w-full max-w-6xl grid md:grid-cols-2 gap-8 items-center">
        ...
        <Card className="w-full max-w-md mx-auto">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {isSignUp 
                ? 'Sign up to access your personalized safety dashboard'
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                {isSignUp ? 'Sign Up with Google Popup' : 'Sign In with Google'}
              </Button>
            ...
            <p className="text-xs text-center text-muted-foreground pt-2">
              By {isSignUp ? 'signing up' : 'signing in'}, you agree to allow location access for safety features and emergency alerts.
            </p>
          </CardContent>
        </Card>
      </div>
